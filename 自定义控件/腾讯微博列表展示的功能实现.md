...
关于TextView 网页，电话，邮箱的自动识别。设置`android:autoLink="email|web|phone|map"`属性后，TextView 可自动识别电话、邮箱、网址、地图为超链接。
...
![](assets/ActivityNotFoundException.png)
...
在清单文件中配置以上Activity，设置Activity的action、category、data
